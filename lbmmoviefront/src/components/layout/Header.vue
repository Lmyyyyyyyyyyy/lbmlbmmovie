  ...
  <div class="header">
    <div style="height: 70px;width: 100%">
      <div class="header-logo">
        ...
        <div class="header-logo-text">ICEMovie</div>
      </div>
      <div class="header-links">
        ...
        <el-link href="/active" class="header-link" :underline="false">新闻</el-link>
      </div>
      ...
      <el-dropdown v-if="isLogin" style="float: right;padding-right: 50px">
        <el-button type="text">
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <el-dropdown-item divided>
            <el-button type="text" @click="handleLogout" :underline="false" style="color: #febd6e">
              <i style="font-size: 15px; padding-right: 3px;color: #febd6e" class="el-icon-switch-button"></i>退出登录
            </el-button>
          </el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
